...
<div>
	<h3>构造传感器数据:</h3>
	<form accept-charset="UTF-8" action="<%=basePath %>sensor_data_update.do" class="form-horizontal" id="device_form2" method="post">
		<div class="form-group">
